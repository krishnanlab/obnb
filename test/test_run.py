...
g = graph.DenseGraph.DenseGraph.from_edglst(\
	'../data/networks/STRING-EXP.edg', weighted=True, directed=False)
lsc = label.LabelsetCollection.SplitLSC.from_gmt('../data/labels/KEGGBP.gmt')
lsc.load_entity_properties('../data/properties/pubcnt.txt', \
		'Pubmed Count', 0, int)
